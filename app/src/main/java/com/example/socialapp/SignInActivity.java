        ...
        db.collection(Constants.KEY_COLLECTION_USERS)
                ...
                .addOnCompleteListener(task -> {
                    if(task.isSuccessful() && task.getResult()!=null
                        ...
                        //preferenceManager.putString(Constants.KEY_IMAGE, documentSnapshot.getString(Constants.KEY_IMAGE));//TODO uncomment this
...
//testing in video 2 put it back into class if you need to see how it runs
